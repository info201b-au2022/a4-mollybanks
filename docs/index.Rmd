...
## Data Summary 
`r county_max_pretrial_rate` had the highest pretrial jail rate between 1970 and 2018. This took place in `r year_max_pretrial_rate`. 
